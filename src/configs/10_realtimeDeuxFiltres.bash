...
sudo ./decodeur -r FIFO 160p/02_Sintel.ulv /mem1 &
sudo ./decodeur 160p/02_Sintel.ulv /mem5 &
sleep 0.5
sudo ./convertisseur -r FIFO /mem1 /mem2 &
sudo ./convertisseur /mem5 /mem6 &
sleep 0.5
sudo ./filtreur -r FIFO -t 0 /mem2 /mem3 &
sudo ./filtreur -t 1 /mem6 /mem7 &
sleep 0.5
sudo ./redimensionneur -r FIFO -w 427 -h 240 -m 0 /mem3 /mem4 &
